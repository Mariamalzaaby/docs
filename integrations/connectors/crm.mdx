...
description: Sync contacts, accounts, deals, and activity from Salesforce, HubSpot, and other CRMs, map fields, and schedule incremental updates in Integrations.
---
