...
description: Register a webhook endpoint, choose which events to subscribe to, sign and verify payloads, and test delivery and retries in Integrations.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    The full list of event types and payload schemas is available in the endpoint configuration UI.
  </Step>
