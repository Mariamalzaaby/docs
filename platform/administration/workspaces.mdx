---
title: Archive, restore, and delete workspaces
description: Archive, restore, or permanently delete a workspace, cancel its Stripe subscription, and use the recently visited list to switch back fast.
---
