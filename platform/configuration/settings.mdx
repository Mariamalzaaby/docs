...
description: Configure your workspace name, timezone, security policies, and the default notification settings applied to new members.
---
...
- **Browser push** — Allow members to subscribe to background push notifications from their personal **Settings → Notifications** page. Push delivery requires each member to grant browser permission and enable the persistent toggle on each device they want to receive alerts on.

Live sidebar badges (Action Items, Approval Routing, QA Inspections, NCR / Defects, Transmittals, and the notifications bell) are always on for members who have access to the relevant section and cannot be turned off from this page.

For the full behaviour of push notifications, sidebar badges, Quick Actions, and deep-link record highlighting, see [Notifications and alerts](/platform/notifications-and-alerts).
