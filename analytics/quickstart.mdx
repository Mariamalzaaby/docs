---
title: Analytics quickstart guide
sidebarTitle: Quickstart
description: Connect your first data source, model a dataset, and build a dashboard with charts, filters, and shared access in Analytics in under 15 minutes.
---
